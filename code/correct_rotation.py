...
if __name__ == '__main__':
    ...
    print('Loading model...')
    model_location = load_model(args.m, custom_objects={'angle_error': angle_error})
    output_path = args.output_path if args.output_path else args.i

    print('Processsing input image(s)...')
    process_images(model_location, args.i, output_path,
